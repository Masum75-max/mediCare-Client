...
export default function DoctorSidebar({ user }) {
  ...
  const navLinks = [
    { name: "Dashboard Overview", href: "/dashboard/doctor", icon: <FaCalendarCheck /> },
    { name: "Manage Schedules", href: "/dashboard/doctor/schedules", icon: <FaClock /> },
    { name: "Appointment Requests", href: "/dashboard/doctor/appointments", icon: <FaClipboardList /> },
    { name: "Prescription Management", href: "/dashboard/doctor/prescriptions", icon: <FaFileMedical /> },
    { name: "Profile Management", href: "/dashboard/doctor/profile", icon: <FaUserCog /> },
  ];
    ...
    <>
      ...
      <div className="lg:hidden flex items-center justify-between bg-zinc-900 border-b border-zinc-800 p-4 sticky top-0 z-40">
        <h2 className="text-lg font-bold text-white flex items-center gap-2">
          <FaUserMd className="text-blue-500" /> Doctor Panel
        </h2>
        <button
        ...
        <div className="space-y-6">
          ...
          <div className="border-b border-zinc-800 pb-4">
            <h2 className="text-xl font-extrabold text-white hidden lg:block">
              Medicare <span className="text-blue-500 text-sm font-semibold">Doctor</span>
            </h2>
            <div className="mt-3 flex items-center gap-3 bg-zinc-800/50 p-2.5 rounded-xl border border-zinc-700/50">
              ...
              <div className="overflow-hidden">
                <p className="text-sm font-bold text-white truncate">{user?.name || "Dr. User"}</p>
